...
func DiscoveryPlus(c http.Client) result.Result {
	resp, err := url.GET(c, "https://us1-prod-direct.discoveryplus.com/token?deviceId=d1a4a5d25212400d1e6985984604d740&realm=go&shortlived=true")
	if err != nil {
